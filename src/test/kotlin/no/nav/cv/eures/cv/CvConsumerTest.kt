...
class CvConsumerTest {
    ...
    @Disabled //until featuretoggling is removed
    @Test
    ...
    private fun internRecord(offset: Long, aktorId: String, dto: CvEndretInternDto)
            = ConsumerRecord<String, String>("\${kafka.aiven.topics.consumers.cv_endret}", PARTITION, offset, aktorId, jacksonMapper.writeValueAsString(dto))
